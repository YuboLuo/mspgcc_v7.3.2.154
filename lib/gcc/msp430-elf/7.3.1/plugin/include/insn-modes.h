/* Generated automatically from machmode.def and config/msp430/msp430-modes.def
   by genmodes.  */
...
#define HAVE_TImode
  PSImode,                 /* config/msp430/msp430-modes.def:2 */
#define HAVE_PSImode

...
#endif
#ifdef GENERATOR_FILE
extern enum msp430_regions msp430_code_region;
#else
  enum msp430_regions x_msp430_code_region;
#define msp430_code_region global_options.x_msp430_code_region
#endif
#ifdef GENERATOR_FILE
extern const char *target_cpu;
#else
  const char *x_target_cpu;
#define target_cpu global_options.x_target_cpu
#endif
#ifdef GENERATOR_FILE
extern enum msp430_regions msp430_data_region;
#else
  enum msp430_regions x_msp430_data_region;
#define msp430_data_region global_options.x_msp430_data_region
#endif
#ifdef GENERATOR_FILE
extern const char *devices_csv_loc;
#else
  const char *x_devices_csv_loc;
#define devices_csv_loc global_options.x_devices_csv_loc
#endif
#ifdef GENERATOR_FILE
extern enum msp430_hwmult_types msp430_hwmult_type;
#else
  enum msp430_hwmult_types x_msp430_hwmult_type;
#define msp430_hwmult_type global_options.x_msp430_hwmult_type
#endif
#ifdef GENERATOR_FILE
extern const char *target_mcu;
#else
  const char *x_target_mcu;
#define target_mcu global_options.x_target_mcu
#endif
#ifdef GENERATOR_FILE
extern int msp430_warn_mcu;
#else
  int x_msp430_warn_mcu;
#define msp430_warn_mcu global_options.x_msp430_warn_mcu
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  const char *x_VAR_msilicon_errata_warn_;
#define x_VAR_msilicon_errata_warn_ do_not_use
#endif
#ifndef GENERATOR_FILE
  const char *x_VAR_msilicon_errata_;
#define x_VAR_msilicon_errata_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_msim;
...
#define MASK_OPT_SPACE (1U << 0)
#define MASK_ASM_HEX (1U << 1)
#define MASK_DISABLE_DEVICE_WARN (1U << 2)
#define MASK_MINRT (1U << 3)
#define MASK_LARGE (1U << 4)

#define TARGET_OPT_SPACE ((target_flags & MASK_OPT_SPACE) != 0)
#define TARGET_OPT_SPACE_P(target_flags) (((target_flags) & MASK_OPT_SPACE) != 0)
#define TARGET_ASM_HEX ((target_flags & MASK_ASM_HEX) != 0)
#define TARGET_ASM_HEX_P(target_flags) (((target_flags) & MASK_ASM_HEX) != 0)
#define TARGET_DISABLE_DEVICE_WARN ((target_flags & MASK_DISABLE_DEVICE_WARN) != 0)
#define TARGET_DISABLE_DEVICE_WARN_P(target_flags) (((target_flags) & MASK_DISABLE_DEVICE_WARN) != 0)
#define TARGET_MINRT ((target_flags & MASK_MINRT) != 0)
#define TARGET_MINRT_P(target_flags) (((target_flags) & MASK_MINRT) != 0)
#define TARGET_LARGE ((target_flags & MASK_LARGE) != 0)
#define TARGET_LARGE_P(target_flags) (((target_flags) & MASK_LARGE) != 0)
...
enum opt_code
{
  ...
  OPT_mOs = 1150,                            /* -mOs */
  OPT_masm_hex = 1151,                       /* -masm-hex */
  OPT_mcode_region_ = 1152,                  /* -mcode-region= */
  OPT_mcpu_ = 1153,                          /* -mcpu= */
  OPT_mdata_region_ = 1154,                  /* -mdata-region= */
  OPT_mdevices_csv_loc_ = 1155,              /* -mdevices-csv-loc= */
  OPT_mdisable_device_warnings = 1156,       /* -mdisable-device-warnings */
  OPT_mhwmult_ = 1157,                       /* -mhwmult= */
  OPT_minrt = 1158,                          /* -minrt */
  OPT_mlarge = 1159,                         /* -mlarge */
  OPT_mmcu_ = 1160,                          /* -mmcu= */
  OPT_mrelax = 1161,                         /* -mrelax */
  OPT_msilicon_errata_warn_ = 1162,          /* -msilicon-errata-warn= */
  OPT_msilicon_errata_ = 1163,               /* -msilicon-errata= */
  OPT_msim = 1164,                           /* -msim */
  OPT_msmall = 1165,                         /* -msmall */
  OPT_mwarn_mcu = 1166,                      /* -mwarn-mcu */
  OPT_n = 1167,                              /* -n */
  OPT_no_canonical_prefixes = 1168,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1169,              /* -no-integrated-cpp */
  OPT_no_pie = 1170,                         /* -no-pie */
  OPT_nocpp = 1171,                          /* -nocpp */
  OPT_nodefaultlibs = 1172,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1173,                   /* -nostartfiles */
  OPT_nostdinc = 1174,                       /* -nostdinc */
  OPT_nostdinc__ = 1175,                     /* -nostdinc++ */
  OPT_nostdlib = 1176,                       /* -nostdlib */
  OPT_o = 1177,                              /* -o */
  OPT_p = 1178,                              /* -p */
  OPT_pass_exit_codes = 1179,                /* -pass-exit-codes */
  /* OPT_pedantic = 1180, */                 /* -pedantic */
  OPT_pedantic_errors = 1181,                /* -pedantic-errors */
  OPT_pg = 1182,                             /* -pg */
  OPT_pie = 1183,                            /* -pie */
  OPT_pipe = 1184,                           /* -pipe */
  OPT_print_file_name_ = 1185,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1186,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1187,          /* -print-multi-directory */
  OPT_print_multi_lib = 1188,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1189,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1190,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1191,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1192,               /* -print-prog-name= */
  OPT_print_search_dirs = 1193,              /* -print-search-dirs */
  OPT_print_sysroot = 1194,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1195,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1196,                          /* -quiet */
  OPT_r = 1197,                              /* -r */
  OPT_remap = 1198,                          /* -remap */
  OPT_s = 1199,                              /* -s */
  OPT_save_temps = 1200,                     /* -save-temps */
  OPT_save_temps_ = 1201,                    /* -save-temps= */
  OPT_shared = 1202,                         /* -shared */
  OPT_shared_libgcc = 1203,                  /* -shared-libgcc */
  /* OPT_specs = 1204, */                    /* -specs */
  OPT_specs_ = 1205,                         /* -specs= */
  OPT_static = 1206,                         /* -static */
  OPT_static_libasan = 1207,                 /* -static-libasan */
  OPT_static_libgcc = 1208,                  /* -static-libgcc */
  OPT_static_libgfortran = 1209,             /* -static-libgfortran */
  OPT_static_libgo = 1210,                   /* -static-libgo */
  OPT_static_liblsan = 1211,                 /* -static-liblsan */
  OPT_static_libmpx = 1212,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1213,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1214,               /* -static-libstdc++ */
  OPT_static_libtsan = 1215,                 /* -static-libtsan */
  OPT_static_libubsan = 1216,                /* -static-libubsan */
  /* OPT_std_c__03 = 1217, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1218, */                /* -std=c++0x */
  OPT_std_c__11 = 1219,                      /* -std=c++11 */
  OPT_std_c__14 = 1220,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1221, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1222, */                /* -std=c++1y */
  OPT_std_c__1z = 1223,                      /* -std=c++1z */
  OPT_std_c__98 = 1224,                      /* -std=c++98 */
  OPT_std_c11 = 1225,                        /* -std=c11 */
  /* OPT_std_c1x = 1226, */                  /* -std=c1x */
  /* OPT_std_c89 = 1227, */                  /* -std=c89 */
  OPT_std_c90 = 1228,                        /* -std=c90 */
  OPT_std_c99 = 1229,                        /* -std=c99 */
  /* OPT_std_c9x = 1230, */                  /* -std=c9x */
  OPT_std_f2003 = 1231,                      /* -std=f2003 */
  OPT_std_f2008 = 1232,                      /* -std=f2008 */
  OPT_std_f2008ts = 1233,                    /* -std=f2008ts */
  OPT_std_f95 = 1234,                        /* -std=f95 */
  OPT_std_gnu = 1235,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1236, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1237, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1238,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1239,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1240, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1241, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1242,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1243,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1244,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1245, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1246, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1247,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1248,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1249, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1250, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1251,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1252, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1253, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1254, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1255,                     /* -std=legacy */
  OPT_symbolic = 1256,                       /* -symbolic */
  OPT_t = 1257,                              /* -t */
  OPT_time = 1258,                           /* -time */
  OPT_time_ = 1259,                          /* -time= */
  OPT_traditional = 1260,                    /* -traditional */
  OPT_traditional_cpp = 1261,                /* -traditional-cpp */
  OPT_trigraphs = 1262,                      /* -trigraphs */
  OPT_u = 1263,                              /* -u */
  OPT_undef = 1264,                          /* -undef */
  OPT_v = 1265,                              /* -v */
  OPT_version = 1266,                        /* -version */
  OPT_w = 1267,                              /* -w */
  OPT_wrapper = 1268,                        /* -wrapper */
  OPT_x = 1269,                              /* -x */
  OPT_z = 1270,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
